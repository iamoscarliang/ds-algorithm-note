...
public class RedBlackTree<T extends Comparable<T>> implements Iterable<T> {
    ...
    // The root node of the RB ds.tree.
    public Node root;

    // Tracks the number of nodes inside the ds.tree.
    private int nodeCount = 0;

    // Returns the number of nodes in the ds.tree.
    public int size() {
        return nodeCount;
    }

    // Returns whether or not the ds.tree is empty.
    ...
    public boolean insert(T value) {
        ...
        for (Node node = root; ; ) {
            ...
            if (cmp < 0) {
                ...
                // The value we're trying to insert already exists in the ds.tree.
            } else return false;
        }
    }
    ...
    private void insertionRelabel(Node node) {
        ...
        // The red-black ds.tree invariant is already satisfied.
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("RB ds.tree contains %d: %s\n", 6, rbTree.contains(6));
        System.out.printf("RB ds.tree contains %d: %s\n", -5, rbTree.contains(-5));
        System.out.printf("RB ds.tree contains %d: %s\n", 1, rbTree.contains(1));
